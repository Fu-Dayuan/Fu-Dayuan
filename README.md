...
- 2026-05: 🎉🎉 One paper has been accepted by ICML 2026 Spotlight!
...
3. daVinci-Env: Open SWE Environment Synthesis at Scale   
   **Dayuan Fu**, Shenyu Wu, Yunze Wu, Zerui Peng, Yaxing Huang, Jie Sun, Ji Zeng, Mohan Jiang, Lin Zhang, Yukun Li, Jiarui Hu, Liming Liu, Jinlong Hou, Pengfei Liu  
   working in progress [paper](https://arxiv.org/pdf/2603.13023) 
4. daVinci-Dev: Agent-native Mid-training for Software Engineering   
   ...
   ICML 2026 spotlight [paper](https://arxiv.org/pdf/2601.18418) 
5. daVinci-Agency: Unlocking Long-Horizon Agency Data-Efficiently   
   Mohan Jiang, **Dayuan Fu**, Junhao Shi, Ji Zeng, Weiye Si, Keyu Li, Xuefeng Li, Yang Xiao, Wenjie Li, Dequan Wang, Pengfei Liu  
    working in progress [paper](https://arxiv.org/pdf/2602.02619) 
6. MSI-Agent: Incorporating Multi-Scale Insight into Embodied Agents for Superior Planning and Decision-Making  
...
8. How Do Your Code LLMs Perform? Empowering Code Instruction Tuning with High-Quality Data  
...
9. PreAct: Prediction Enhances Agent's Planning Ability  
...
10. CS-Bench: A Comprehensive Benchmark for Large Language Models towards Computer Science Mastery
...
<!--
11. On Large Language Models' Hallucination with Regard to Known Facts  
...
12. DivTOD: Unleashing the Power of LLMs for Diversifying Task-Oriented Dialogue Representations  
   Weihao Zeng\*, **Dayuan Fu\***, Keqing He, Yejie Wang, Yukai Xu, Weiran Xu  
   NAACL 2024 Findings [paper](https://arxiv.org/abs/2404.00557)
13. Semi-supervised knowledge-grounded pre-training for task-oriented dialog systems  
